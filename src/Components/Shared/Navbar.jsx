            ...
            <div className="navbar container mx-auto">
                <div className="navbar-start">
                    ...
                    >
                        ...
                        <h2 className="text-2xl font-bold text-[#F17228]">
                            food<span className="text-[#FFB30E]">wagon</span>
                        </h2>
                    </Link>
                </div>
                ...
                <div className="navbar-end items-center">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center cursor-pointer relative">
                        <span className="absolute text-[#FF4D00] -top-2 right-1">
                            1
                        </span>
                        ...
                        >
                            ...
                            {open && (
                                <ul className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 mx-auto absolute right-0">
                                    <li>
                                        <Link className="hover:text-white hover:bg-gradient-to-r from-[#FFAE00] to-[#FF8A00] cursor-auto">
                                            {user?.displayName}
                                        </Link>
                                    </li>
                                    <li>
                                        <Link
                                            ...
                                            className="hover:text-white hover:bg-gradient-to-r from-[#FFAE00] to-[#FF8A00]"
                                        >
                                            Dashboard
                                        </Link>
                                    </li>
