                ...
                <section className="bg-base-100 py-16 text-center">
                    <div className="max-w-7xl mx-auto px-4">
                        ...
                        <p className="text-base-content mb-10 max-w-2xl mx-auto">
                            We deliver quality and speed you can trust — see
...
const ReviewCard = ({ review, position, isActive, onClick, showFullText }) => {
    return (
        <div
            onClick={onClick}
            className={`cursor-pointer w-64 shadow-md p-5 rounded-xl h-80 transition-all duration-500 transform ${getTranslateY(
                position
            )} ${
                isActive
                    ? "bg-white scale-100 opacity-100 z-10"
                    : "bg-base-200 scale-95 opacity-50 z-0"
            }`}
        >
                ...
                <div className="rating">
                    {[1, 2, 3, 4, 5].map((num) => (
                        <input
                            key={num}
                            type="radio"
                            name={`rating-${review?.userId?.name}`} // unique per review
            ...
            <div
                className={`text-base-content w-full rounded-md text-left pr-2 h-44 overflow-y-auto p-2`}
            >
